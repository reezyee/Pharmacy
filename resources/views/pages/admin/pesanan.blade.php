...
@section('content')
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-100 bg-opacity-70">
                            <tr>
                        ...
                        <tbody>
                            @foreach ($orders as $order)
                                <tr class="bg-white bg-opacity-40 border-b hover:bg-blue-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 capitalize">
                                        ...
                                        @elseif ($order->payment_method === 'cod')
                                            <span class="flex items-center">
                                                <svg class="w-6 h-6 mr-2 text-green-500" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        @else
                                            <span class="flex items-center">
                                                <svg class="w-6 h-6 mr-2 text-purple-500" fill="none"
                                                    stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            @if (!in_array($order->status, ['completed', 'cancelled']))
                                                <form action="{{ route('admin.orders.updateStatus', $order->id) }}"
                                                    ...
                                                    @csrf
                                                    <select name="status" onchange="this.form.submit()"
                                                        class="text-sm border-0 border-b-2 border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 bg-gray-50 bg-opacity-70 py-2 px-3">
    ...
    @push('scripts')
        <script defer>
            ...
            // Material Design-inspired notification
            function showNotification(message, type) {
                const notification = document.createElement('div');
                notification.className = `fixed bottom-4 right-4 px-6 py-3 rounded-lg shadow-lg flex items-center space-x-2 
